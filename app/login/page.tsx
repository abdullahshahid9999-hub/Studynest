    ...
    <div style={{
      ...
      <div style={{ width:"100%", maxWidth:400, animation:"fadeUp 0.5s ease", position:"relative" }}>
        ...
        <div style={{ textAlign:"center", marginBottom:28 }}>
          ...
          <div style={{ fontSize:13, color:"rgba(255,255,255,0.7)", marginTop:3 }}>Admin Portal · NTU</div>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize:18, fontWeight:800, color:"#111", marginBottom:22, letterSpacing:"-0.3px" }}>Sign in to continue</h2>

          <form onSubmit={login} style={{ display:"flex", flexDirection:"column", gap:16 }}>
            <div>
              <label style={{ display:"block", fontSize:12, fontWeight:700, color:"#555", marginBottom:6, letterSpacing:"0.04em" }}>EMAIL</label>
            ...
            <div>
              ...
              <div style={{ position:"relative" }}>
                <input type={showPass ? "text" : "password"} value={password}
                  ...
                  autoComplete="current-password" placeholder="••••••••" className="login-input"
